...
void main() {
  testWidgets('Example app runs, hovers, and scrolls with mouse wheel without errors', (WidgetTester tester) async {
    ...
    final Offset carouselCenter = tester.getCenter(find.byType(CoverflowCarousel));
